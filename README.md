[![Build Status](https://gitlab.gnome.org/GNOME/regolith-control-center/badges/master/build.svg)](https://gitlab.gnome.org/GNOME/regolith-control-center/pipelines)
